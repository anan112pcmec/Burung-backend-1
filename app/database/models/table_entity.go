...
type Kurir struct {
	...
	StatusBid        string         `gorm:"column:status_bid;type:status_kurir;not null;default:'Off'" json:"status_bid_kurir"`
	...
	TipeKendaraan    string         `gorm:"column:jenis_kendaraan;type:jenis_kendaraan_kurir;default:'Unknown'" json:"tipe_kendaraan_kurir"`
	CreatedAt        time.Time      `gorm:"autoCreateTime" json:"created_at"`
	UpdatedAt        time.Time      `gorm:"autoUpdateTime" json:"updated_at"`
	DeletedAt        gorm.DeletedAt `gorm:"index" json:"deleted_at,omitempty"`
}
